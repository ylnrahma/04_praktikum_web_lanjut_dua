        ...
        <div class="small-box bg-light" style="width: 200px auto">
            <div class="inner">
                <center>
                    ...
                    <center>
                    <h4 style="font-weight: bold">Profil</h4><br><br>
                    <img src="dist/img/mine.jpg" alt="foto" style="width:200px" display:block> <br><br>    
                    <h4 style="font-weight: bold">Biodata</h4>
                    <br><br>
                    <div class="container text-left">
                            <div class="container text-left">
                            <div class="row">
                                <div class="col-sm-6 col-md-6">Nama Lengkap </div>
                                <div class="col-sm-6 col md 6       ">: {!! $yfull_name !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">Nama Panggilan </div>
                                <div class="col-sm-6 col md 6       ">: {!! $yshort_name !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">NIM </div>
                                <div class="col-sm-6 col md 6       ">: {!! $ynim !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">Absen </div>
                                <div class="col-sm-6 col md 6       ">: {!! $yabsen !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">Kelas </div>
                                <div class="col-sm-6 col md 6       ">: {!! $yclass !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">Program Studi </div>
                                <div class="col-sm-6 col md 6       ">: {!! $yprodi !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">Jurusan </div>
                                <div class="col-sm-6 col md 6       ">: {!! $yjurusan !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">Perguruan Tinggi </div>
                                <div class="col-sm-6 col md 6       ">: {!! $ykampus !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">Email </div>
                                <div class="col-sm-6 col md 6       ">: {!! $yemail !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">Id Tiktok</div>
                                <div class="col-sm-6 col md 6       ">: {!! $ytiktok !!}</div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6 col-md-6">ID Instagram </div>
                                <div class="col-sm-6 col md 6       ">: {!! $yig !!}</div>
                            </div>
                        </b>
                        </h4>
                    </div>
